...
<html lang="ro-RO">
<head>
    <title>Girl Playing Violin</title>
    <meta charset="utf-16">
                    ...
                    <div class="news_post_container">
                        ...
                        <div class="news_post">
                            <div class="news_post_image">
                                <img src="images/painting16.webp" alt="https://unsplash.com/@dsmacinnes">
                            </div>
                            <div class="news_post_top d-flex flex-column flex-sm-row">
                                <div class="news_post_date_container">
                                    <div class="news_post_date d-flex flex-column align-items-center justify-content-center">
                                        <div style="font-size:18px;">$109</div>
                                    </div>
                                </div>
                                <div class="news_post_title_container">
                                    <div class="news_post_title">
                                        <a href="painting16.html">Girl Playing Violin</a>
                                    </div>
                                    <div class="news_post_meta">
                                        <span class="news_post_author"><a href="artist6.html" style="font-size:18px;">Sandra Christian</a></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="news_post_text">
                                ...
                                <table><tr><th width="100px"></th><th></th>
                                    ...
                                    <tr height="50px"><td><b>ID:</b></td>    <td>18</td></tr>
                                    <%
                                                }
                                            }
                                        } catch (Exception e) {
                                ...
                                <div class="search_section d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    <div class="search_content text-center">
                                        ...
                                        <form id="search_form" class="search_form" action="addToCart-servlet" method="post">
                                            <div class="buttons" ><div class="buttons_container" ><span><button id="search_submit_button" type="submit" class="button button_color_1 text-center trans_200" name="btn_painting16" value="painting16" style="width:205px; border-style:none;">
                        ...
                        <div class="sidebar_section">
                            ...
                            <div class="latest_posts">
                                ...
                                <div class="latest_post">
                                    ...
                                    <div class="latest_post_title"><a href="painting1.html">Rocking Lady</a></div>
                                    <div class="latest_post_meta">
                                        <span class="latest_post_author"><a href="artist2.html">Rose Simpson</a></span>
                                        <span>|</span>
                                ...
                                <div class="latest_post">
                                    ...
                                    <div class="latest_post_title"><a href="painting2.html">Lips</a></div>
                                    <div class="latest_post_meta">
                                        <span class="latest_post_author"><a href="artist1.html">Robert Smith</a></span>
                                        <span>|</span>
                                ...
                                <div class="latest_post">
                                    ...
                                    <div class="latest_post_title"><a href="painting3.html">Dance of Passion</a></div>
                                    <div class="latest_post_meta">
                                        <span class="latest_post_author"><a href="artist6.html">Sandra Christian</a></span>
                                        <span>|</span>
