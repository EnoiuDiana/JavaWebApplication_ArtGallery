...
<div class="super_container">
    ...
    <div class="home">
        <div class="home_background_container prlx_parent">
            <div class="home_background prlx" style="background-image:url(images/artists.jpg)"></div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row course_boxes">
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/artist10.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a style="font-size: 18px">Robert Smith</a></div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                        </div>
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/artist2.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a style="font-size: 18px">Rose Simpson</a></div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/artist3.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a style="font-size: 18px">Beatrice Stearns</a></div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/artist4.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a style="font-size: 18px">David Anderson</a></div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/artist5.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a style="font-size: 18px">Ellen Muller</a></div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/artist6.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a style="font-size: 18px">Sandra Christian</a></div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/artist1.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a style="font-size: 18px">Anthony Kinney</a></div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/artist8.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a style="font-size: 18px">Cecile Lawrence</a></div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/artist9.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a style="font-size: 18px">Tyrone McCarter</a></div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
                            <div class="card-text" style="color:#f8f9fb">bghggf</div>
