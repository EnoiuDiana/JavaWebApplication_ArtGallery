...
<div class="super_container">
    ...
    <header class="header d-flex flex-row">
            ...
            <nav class="main_nav_container">
                <div class="main_nav">
                    <ul class="main_nav_list">
                        ...
                        <li class="main_nav_item"><a href="artists.html">Artists</a></li>
                        <li class="main_nav_item"><a href="exhibitions.html">Exhibitions</a></li>
        ...
        <div class="header_side d-flex flex-row justify-content-center align-items-center">
			<span>
			   <ul>
				  <li style='font-size:18px; text-align:center;'><a href="myaccount.html">My Account</a></li>
			   </ul>
			</span>
        </div>
        ...
        <div class="menu_inner menu_mm">
            <div class="menu menu_mm">
                <ul class="menu_list menu_mm">
                    ...
                    <li class="menu_item menu_mm"><a href="paintings.html">Artworks</a></li>
                    <li class="menu_item menu_mm"><a href="artists.html">Artists</a></li>
                    <li class="menu_item menu_mm"><a href="exhibitions.html">Exhibitions</a></li>
                    ...
                    <div class="news_post_container">
                        ...
                        <div class="news_post">
                            <div class="news_post_image">
                                <img src="images/exhibition2.jpg" alt="https://unsplash.com/@dsmacinnes">
                            </div>
                            <div class="news_post_top d-flex flex-column flex-sm-row">
                                <div class="news_post_title_container">
                                    <div class="news_post_title">
                                        <a href="exhibition2.jsp">Speech/Acts</a>
                                    </div>
                                    <div class="news_post_meta">
                                        <span class="news_post_author"><a href="artists.jsp" style="font-size:18px;">Robert Smith</a></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="news_post_text">
                                ...
                                <table><tr><th width="100px"></th><th></th>
                                        <%
                                        try {
                                            String query = "select exhibition.Name, artist.Name, exhibition.Date, gallery.Name, address.Building, address.Street, address.City, address.Country\n" +
                                                           "from exhibition\n" +
                                                            "    join gallery on exhibition.GalleryID = gallery.GalleryID\n" +
                                                            "    join address on gallery.AddressID = address.AddressID\n" +
                                                            "join artist on exhibition.ArtistID = artist.ArtistID\n" +
                                                            "where ExhibitionID = 2;";
                                    ...
                                    <tr height="50px"><td><b>Period:</b></td>    <td><%=rs.getString(3)%></td></tr>
                                    <tr height="50px"><td><b>Gallery</b></td>    <td><%=rs.getString(4)%></td></tr>
                                    <tr height="50px"><td><b>Address:</b></td>     <td><%=rs.getString(5)%> <%=rs.getString(6)%>, <%=rs.getString(7)%>, <%=rs.getString(8)%></td></tr>
                                    <%
                                                }
                                            }
                                        } catch (Exception e) {
                                ...
                                <div class="news_post_meta">
                                    <span class="news_post_author"><a href="#" style="font-size:18px;">Paintings:</a></span>
                                </div>
                                <div class="row course_boxes">
                                    ...
                                    <div class="col-lg-4 course_box">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <div class="news_post_meta">
                                                    <span class="news_post_author"><a href="painting6.jsp" style="font-size:18px;">Jazz</a></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 course_box">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <div class="news_post_meta">
                                                    <span class="news_post_author"><a href="painting17.jsp" style="font-size:18px;">Fengshui Flower</a></span>
                                                </div>
                                    ...
                                    <div class="col-lg-4 course_box">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <div class="news_post_meta">
                                                    <span class="news_post_author"><a href="painting13.jsp" style="font-size:18px;">Determinism</a></span>
                                                </div>
                                            </div>
