...
<html lang="ro-RO">
<head>
    <title>R.I.S.E.: Nothing is Natural</title>
    <meta charset="utf-16">
                    ...
                    <div class="news_post_container">
                        ...
                        <div class="news_post">
                            <div class="news_post_image">
                                <img src="images/exhibition3.jpg" alt="https://unsplash.com/@dsmacinnes">
                            </div>
                            <div class="news_post_top d-flex flex-column flex-sm-row">
                                <div class="news_post_title_container">
                                    <div class="news_post_title">
                                        <a href="exhibition3.jsp">R.I.S.E.: Nothing is Natural</a>
                                    </div>
                                    <div class="news_post_meta">
                                        <span class="news_post_author"><a href="artists.jsp" style="font-size:18px;">Sandra Christian</a></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row course_boxes">
                                    ...
                                    <div class="col-lg-4 course_box">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <div class="news_post_meta">
                                                    <span class="news_post_author"><a href="painting3.jsp" style="font-size:18px;">Dance of Passion</a></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 course_box">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <div class="news_post_meta">
                                                    <span class="news_post_author"><a href="painting14.jsp" style="font-size:18px;">Lady with Umbrella</a></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 course_box">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <div class="news_post_meta">
                                                    <span class="news_post_author"><a href="painting15.jsp" style="font-size:18px;">Dancing Lady in Red</a></span>
                                                </div>
                                    ...
                                    <div class="col-lg-4 course_box">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <div class="news_post_meta">
                                                    <span class="news_post_author"><a href="painting16.jsp" style="font-size:18px;">Girl Playing Violin</a></span>
                                                </div>
                                            </div>
