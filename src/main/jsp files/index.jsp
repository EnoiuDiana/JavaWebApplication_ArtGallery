                                    ...
                                    <div class="search_section d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div class="search_content text-center">
                                            ...
                                            <form id="search_form" class="search_form" action="login-servlet" method = "post">
                                                ...
                                                <button id="search_submit_button" type="submit" name="loginButton" class="search_submit_button trans_200" value="login">
                                                    <a href="login-servlet" style="color:black;">Log In</a></button>
                                                <h2 class="register_login">Don't have an account yet?
                                                    <li class="register_login"><a href="register.jsp">Sign Up</a></li></h2>
                                            </form>
                                        </div>
                                    </div>
