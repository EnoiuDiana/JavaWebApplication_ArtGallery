                                    ...
                                    <div class="search_section d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div class="search_content text-center">
                                            <form id="search_form" class="search_form" action="signup-servlet" method="post">
                                                <h3 class="register_login" style="color:red;">Your data is incorrect.</h3>
                                                <h3>     </h3>
                                                <h3>     </h3>
                                                <h3>     </h3>
                                                <h3>     </h3>
                                        ...
                                        <div class="search_content text-center">
                                            ...
                                            <form id="search_form2" class="search_form" action="signup-servlet" method="post">
                                                ...
                                                <button id="search_submit_button" type="submit" class="search_submit_button trans_200" value="signup"><a href="signup-servlet" style="color:black;">Register</a></button>
