...
<html lang="ro-RO">
<head>
    <title>The Advent of The Artist</title>
    <meta charset="utf-16">
                    ...
                    <div class="news_post_container">
                        ...
                        <div class="news_post">
                            <div class="news_post_image">
                                <img src="images/exhibition1.jpg" alt="https://unsplash.com/@dsmacinnes">
                            </div>
                            <div class="news_post_top d-flex flex-column flex-sm-row">
                                <div class="news_post_title_container">
                                    <div class="news_post_title">
                                        <a href="exhibition1.jsp">The Advent of the Artist</a>
                                    </div>
                                    <div class="news_post_meta">
                                        <span class="news_post_author"><a href="artists.jsp" style="font-size:18px;">Rose Simpson</a></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row course_boxes">
                                    ...
                                    <div class="col-lg-4 course_box">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <div class="news_post_meta">
                                                    <span class="news_post_author"><a href="painting1.jsp" style="font-size:18px;">Rocking Lady</a></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 course_box">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <div class="news_post_meta">
                                                    <span class="news_post_author"><a href="painting4.jsp" style="font-size:18px;">Ballet</a></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 course_box">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <div class="news_post_meta">
                                                    <span class="news_post_author"><a href="painting18.jsp" style="font-size:18px;">Adoring Companion</a></span>
                                                </div>
                                    ...
                                    <div class="col-lg-4 course_box">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <div class="news_post_meta">
                                                    <span class="news_post_author"><a href="painting10.jsp" style="font-size:18px;">Piano Girl</a></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 course_box">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <div class="news_post_meta">
                                                    <span class="news_post_author"><a href="painting8.jsp" style="font-size:18px;">Ballet Dancer</a></span>
                                                </div>
                                            </div>
