...
<html lang="ro-RO">
<head>
    <title>Eternal Reflection</title>
    <meta charset="utf-16">
                    ...
                    <div class="news_post_container">
                        ...
                        <div class="news_post">
                            <div class="news_post_image">
                                <img src="images/sculpture3.jpg" alt="https://unsplash.com/@dsmacinnes">
                            </div>
                            <div class="news_post_top d-flex flex-column flex-sm-row">
                                <div class="news_post_date_container">
                                    <div class="news_post_date d-flex flex-column align-items-center justify-content-center">
                                        <div style="font-size:18px;">$270</div>
                                    </div>
                                </div>
                                <div class="news_post_title_container">
                                    <div class="news_post_title">
                                        <a href="sculpture3.jsp">Eternal Reflection</a>
                                    </div>
                                    <div class="news_post_meta">
                                        <span class="news_post_author"><a href="artists.jsp" style="font-size:18px;">Tyron McCarter</a></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="news_post_text">
                                ...
                                <table><tr><th width="100px"></th><th></th>
                                        <%
                                        try {
                                            String query = "select artwork.Title, artist.name as 'artist', artwork.Year, style.name as 'style', artwork.Price, artwork.Description,\n" +
                                                           "sculpture.Material, sculpture.Height, sculpture.Width, sculpture.Depth\n" +
                                                           "from artwork\n" +
                                                           "    join sculpture on artwork.ArtID = sculpture.ArtID\n" +
                                                           "    join artist on artwork.ArtistID = artist.ArtistID\n" +
                                                           "    join style on artwork.StyleID = style.StyleID\n" +
                                                           "where artwork.ArtID = 26;";
                                    ...
                                    <tr height="50px"><td><b>Height:</b></td>    <td><%=rs.getString(8)%>"</td></tr>
                                    <tr height="50px"><td><b>Width:</b></td>    <td><%=rs.getString(9)%>"</td></tr>
                                    <tr height="50px"><td><b>Depth:</b></td>    <td><%=rs.getString(10)%>"</td></tr>
                                    <tr height="50px"><td><b>Material:</b></td>    <td><%=rs.getString(7)%></td></tr>
                                    <tr height="50px"><td><b>Description:</b></td>    <td><%=rs.getString(6)%></td></tr>
                                    ...
                                    <tr height="50px"><td><b>ID:</b></td>    <td>26</td></tr>
                                    <%
                                                }
                                            }
                                        } catch (Exception e) {
                                ...
                                <div class="search_section d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    <div class="search_content text-center">
                                        ...
                                        <form id="search_form" class="search_form" action="addToCart-servlet" method="post">
                                            <div class="buttons" ><div class="buttons_container" ><span><button id="search_submit_button" type="submit" class="button button_color_1 text-center trans_200" name="btn_sculpture3" value="sculpture3" style="width:205px; border-style:none;">
                        ...
                        <div class="sidebar_section">
                            ...
                            <div class="latest_posts">
                                ...
                                <div class="latest_post">
                                    ...
                                    <div class="latest_post_title"><a href="paintings.jsp">Dance of Passion</a></div>
                                    <div class="latest_post_meta">
