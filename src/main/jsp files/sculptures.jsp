...
<div class="super_container">
    ...
    <div class="home">
        <div class="home_background_container prlx_parent">
            <div class="home_background prlx" style="background-image:url(images/sculptures.jpg)"></div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row course_boxes">
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/sculpture1.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a href="sculpture1.jsp"style="font-size: 18px">Infinity</a></div>
                            <div class="card-text"><a href="artists.jsp" style="color:#a5a5a5;">Tyrone McCarter</a></div>
                        </div>

                        <div class="price_box d-flex flex-row align-items-center">

                            <form id="search_form1" class="search_form" action="addToCart-servlet" method = "post">
                                <div class="course_author_name" ><button id="search_submit_button1" type="submit"  name="btn_sculpture1" value="sculpture1" style="font-weight:600; border-style:none; background-color: #eaebec ">
                            ...
                            <div class="course_price d-flex flex-column align-items-center justify-content-center"><span><h3>$180</h3></span></div>
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/sculpture2.jpg" alt="https://unsplash.com/@kellybrito" style="height:468px">
                        <div class="card-body text-center">
                            <div class="card-title"><a href="sculpture2.jsp"style="font-size: 18px">Hybrid Lamb</a></div>
                            <div class="card-text"><a href="artists.jsp" style="color:#a5a5a5;">Cecile Lawrence</a></div>
                        </div>

                        <div class="price_box d-flex flex-row align-items-center">

                            <form id="search_form2" class="search_form" action="addToCart-servlet" method = "post">
                                <div class="course_author_name" ><button id="search_submit_button2" type="submit"  name="btn_sculpture2" value="sculpture2" style="font-weight:600; border-style:none; background-color: #eaebec ">
                                    <a href="addToCart-servlet" target="_blank" style="color:black"><img src="images\cart.svg" width='29px' height='29px'></a></button>&nbsp &nbsp Add to Cart</div>

                            </form>


                            <div class="course_price d-flex flex-column align-items-center justify-content-center"><span><h3>$340</h3></span></div>
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/sculpture3.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a href="sculpture3.jsp"style="font-size: 18px">Eternal Reflection</a></div>
                            <div class="card-text"><a href="artists.jsp" style="color:#a5a5a5;">Tyron McCarter</a></div>
                        </div>

                        <div class="price_box d-flex flex-row align-items-center">

                            <form id="search_form3" class="search_form" action="addToCart-servlet" method = "post">
                                <div class="course_author_name" ><button id="search_submit_button3" type="submit"  name="btn_sculpture3" value="sculpture3" style="font-weight:600; border-style:none; background-color: #eaebec ">
                                    <a href="addToCart-servlet" target="_blank" style="color:black"><img src="images\cart.svg" width='29px' height='29px'></a></button>&nbsp &nbsp Add to Cart</div>

                            </form>


                            <div class="course_price d-flex flex-column align-items-center justify-content-center"><span><h3>$270</h3></span></div>
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/sculpture4.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a href="sculpture4.jsp"style="font-size: 18px">Renaissance</a></div>
                            <div class="card-text"><a href="artists.jsp" style="color:#a5a5a5;">Cecile Lawrence</a></div>
                        </div>
                        ...
                        <div class="price_box d-flex flex-row align-items-center">
                            ...
                            <form id="search_form4" class="search_form" action="addToCart-servlet" method = "post">
                                <div class="course_author_name" ><button id="search_submit_button4" type="submit"  name="btn_sculpture4" value="sculpture4" style="font-weight:600; border-style:none; background-color: #eaebec ">
                                    <a href="addToCart-servlet" target="_blank" style="color:black"><img src="images\cart.svg" width='29px' height='29px'></a></button>&nbsp &nbsp Add to Cart</div>
                ...
                <div class="col-lg-4 course_box">
                    <div class="card">
                        <img class="card-img-top" src="images/sculpture5.jpg" alt="https://unsplash.com/@kellybrito">
                        <div class="card-body text-center">
                            <div class="card-title"><a href="sculpture5.jsp" style="font-size: 18px">Jardin Secret</a></div>
                            <div class="card-text"><a href="artists.jsp" style="color:#a5a5a5;">Cecile Lawrence</a></div>
                        </div>
                        ...
                        <div class="price_box d-flex flex-row align-items-center">
                            ...
                            <form id="search_form" class="search_form" action="addToCart-servlet" method = "post">
                                <div class="course_author_name" ><button id="search_submit_button" type="submit"  name="btn_sculpture5" value="sculpture5" style="font-weight:600; border-style:none; background-color: #eaebec ">
                                    <a href="addToCart-servlet" target="_blank" style="color:black"><img src="images\cart.svg" width='29px' height='29px'></a></button>&nbsp &nbsp Add to Cart</div>

                            </form>


                            <div class="course_price d-flex flex-column align-items-center justify-content-center"><span><h3>$380</h3></span></div>
